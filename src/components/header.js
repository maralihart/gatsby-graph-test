            ...
            return (
              <Link
                ...
                className={cx(
                  ...
                  {
                    'border-yellow-500 text-gray-900 focus:border-yellow-600': isActive,
                  ...
                  return (
                    <Link
                      ...
                      className={cx(
                        ...
                        {
                          'border-yellow-500 text-yellow-500 bg-yellow-50 focus:text-yellow-600 focus:bg-yellow-100 focus:border-yellow-600': isActive,
